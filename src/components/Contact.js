...
export const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const phoneNumber = "51939462119"; 
    const message = `🙋 Hola, soy ${formDetails.firstName} ${formDetails.lastName}
                  ...
                  <form onSubmit={handleSubmit}>
                    <Row>
                      ...
                      <Col size={12} className="px-1">
                        <textarea rows="6" value={formDetails.message} placeholder="Mensajee" onChange={(e) => onFormUpdate('message', e.target.value)}></textarea>
